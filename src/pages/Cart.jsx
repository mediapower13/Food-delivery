      ...
      <div className="md:hidden px-4 py-6">
        {items.length === 0 ? (
          ...
          <div className="space-y-4">
                ...
                <div className="flex gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-2">
                      <h3 className="font-bold text-sm text-textDark flex-1">
                        {i.food.name}
                      </h3>
                      <button
                        className="h-6 w-6 rounded-sm bg-black text-white hover:bg-black/80 flex items-center justify-center flex-shrink-0 text-sm"
                        aria-label="Remove"
                    ...
                    <div className="text-xs text-textDark/60 mt-1">
                    ...
                    <div className="flex items-center justify-between mt-3">
                      <div className="flex items-center gap-2">
                        <button
                          className="h-7 w-7 rounded-md bg-gray-100 hover:bg-gray-200 flex items-center justify-center font-bold"
                          onClick={() => setQty(i.lineId, i.qty - 1)}
                          aria-label="Decrease"
                        >
                          −
                        </button>
                        <div className="w-8 text-center font-bold text-sm">{i.qty}</div>
                        <button
                          className="h-7 w-7 rounded-md bg-gray-100 hover:bg-gray-200 flex items-center justify-center font-bold"
                          onClick={() => setQty(i.lineId, i.qty + 1)}
                          aria-label="Increase"
                      ...
                      <Price
                        ...
                        className="text-brandOrange font-bold text-base"
                      />
                    </div>
                  </div>
                </div>
            ...
            <Link
              to="/explore"
              className="inline-flex items-center gap-1 text-brandBlue text-sm hover:underline"
            >
              <span>+</span>
